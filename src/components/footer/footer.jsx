...
const portfolioLinks = [
  ...
  { label: 'HD Makeup', path: '/portfolio?category=hd' },
  { label: 'Reception Makeup', path: '/portfolio?category=reception' },
  { label: 'Engagement Makeup', path: '/portfolio?category=engagement' },
  { label: 'Hairstyling', path: '/portfolio?category=hairstyle' },
  { label: 'Saree Draping', path: '/portfolio?category=saree' },
  { label: 'Baby Shower Makeup', path: '/portfolio?category=babyshower' },
]
